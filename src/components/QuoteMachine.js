...
class Presentational extends React.Component {
    ...
    render() {
        ...
        const textStyles = { color: this.props.color }
            ...
            <div className='quote-box' id='quote-box'>
                ...
                <div className='btn-div'>
                    <div className='socials'>
                        <a className='link' id='tweet-quote' style={buttonStyles} href='https://www.twitter.com/intent/tweet' rel='noreferrer' target='_blank'><div className='overlay'></div><i className='fa fa-twitter'></i></a>
                    </div>
