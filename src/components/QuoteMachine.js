    ...
    render() {
        ...
        return (
            <div className='quote-box' id='quote-box'>
                <p className={this.props.fetching ? 'quote fadeOut' : 'quote fadeIn'} id='text' style={textStyles}><i className='fa fa-quote-left'></i> { this.props.quote.content }</p>
                ...
                <div className='btn-div'>
                    <div className='socials'>
                        <a className='link' style={textStyles} href='https://www.twitter.com/intent/tweet'><i className='fa fa-2x fa-twitter'></i></a>
